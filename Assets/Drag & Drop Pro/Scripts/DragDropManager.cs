...
public class DragDropManager : MonoBehaviour {
	...
	public static void Reset () {
		...
		//DDM.OpenDragObjControl();
		DDM.Init();
    }
	public  void CloseDragObjControl()
    {
		for (int i = 0; i < DDM.AllObjects.Length; i++)
		{
			DDM.AllObjects[i].GetComponent<Image>().raycastTarget = false;
		}
	}
	public  void OpenDragObjControl()
	{
		for (int i = 0; i < DDM.AllObjects.Length; i++)
		{
			DDM.AllObjects[i].GetComponent<Image>().raycastTarget = true;
		}
	}
